...
namespace StellarWolf.Core
{
    ...
    public struct Dice : IComparable<Dice>, IEquatable<Dice>
    {
        ...
        [SerializeField, Min ( 1 ), Tooltip ( "The number of dice in the set." )] private int m_Count;
        [SerializeField, Tooltip ( "The number of sides a die in the set has." )] private DieType m_Type;
